...
<svelte:head>
	<title>Tambah Layanan Medis - Kasirung SIMKlinik</title>
</svelte:head>

<div class="flex-1 space-y-4 p-8">
	<div class="flex items-center justify-between">
		<div>
			<h2 class="text-3xl font-bold tracking-tight">Tambah Layanan Medis</h2>
			<p class="text-muted-foreground">Tambahkan layanan baru untuk klinik</p>
		</div>
	...
	<Card class="max-w-3xl">
		<CardHeader>
			...
			<CardDescription>Lengkapi detail layanan yang akan ditambahkan</CardDescription>
		</CardHeader>
		<CardContent>
