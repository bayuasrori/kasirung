<script lang="ts">
  ...
  export let sortDir: string;
</script>

<form
  method="GET"
  class="grid gap-4 rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm backdrop-blur md:grid-cols-[320px_180px_160px_auto]"
>
  <div class="space-y-2">
